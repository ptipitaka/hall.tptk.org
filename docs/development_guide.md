...
| **Spaces**        | bucket `sacred` · region **sgp1** — [Control Panel](https://cloud.digitalocean.com/spaces/sacred) · prefix `archive/` (สแกน) และ `backups/` (DB) |
...
**Spaces (production):** bucket `sacred` · region `sgp1` · endpoint `https://sgp1.digitaloceanspaces.com` · URL สาธารณะ `https://sacred.sgp1.digitaloceanspaces.com`
